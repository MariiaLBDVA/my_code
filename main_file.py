...
class CompositionCalculator:
    ...
    def calculate_ore_composition(self, Fe_w, S_w, As_w, K_w, NH4_w,
        ...
        mass_liquid = (mass_ore - mass_solid) / 1000 # кг
        ...
        n_S_excess = 0 # количество серы вне пирита и арсенопирита
        n_Fe_excess = 0 # количество железа вне пирита и арсенопирита
